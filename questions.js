const allQuestions = {
    "Assignment 1": [
        {
            ...
            correctAnswer: "Higher reproductive rate means higher fitness."
        },
        {
            question: "Ecology is the scientific study of interactions among organisms and their (Fill in the blanks)",
            options: [
                "habitat",
                "niche",
                "environment",
        ...
        {
            question: "Ecology is the scientific study of that determine the distribution and abundance of organisms. (Fill in the blanks)",
            options: [
                "statics",
                "interactions",
                "dynamics",
        ...
        },
        {
            ...
            correctAnswer: "Fitness works on traits such as size and speed."
        },
        {
    ...
    "Assignment 2": [
        ...
        {
            question: "Hierarchy emerges almost inevitably through a wide variety of evolutionary processes, for the simple reason that hierarchical structures are (Fill in the blank)",
            options: [
                "perfect",
                "imperfect",
                "stable",
        ...
        },
        {
            ...
            correctAnswer: "gamma (y) biodiversity"
        },
        {
            ...
            correctAnswer: "alpha (a) biodiversity"
        },
        {
    ...
    "Assignment 4": [
        {
            question: "Frugivorous birds Hawk represents",
            options: [
    ...
    "Assignment 5": [
        ...
        {
            question: "____ employs a simple rule of selecting every kth unit starting with a number chosen at random from 1 to k as the random start.",
            options: [
    ...
    "Assignment 6": [
        ...
        },
        {
            ...
            options: [
                ...
                "Crustose lichen -> Foliose lichen -> Rock -> Moss -> Herbaceous stage -> Shrub -> Woodland -> Climax",
    ...
    "Assignment 9": [
        ...
        {
            question: "____ is used to identify which potential impacts are relevant to assess. (Fill in the blank)",
            options: [
                "screening",
                "scoping",
                "reporting",
        ...
        },
        {
            ...
            correctAnswer: "$I=P\\times A\\times T$"
        },
        {
            question: "____ determines which projects or developments require a full or partial impact assessment study. (Fill in the blank)",
            options: [
                "screening",
                "scoping",
                "reporting",
    ...
    "Assignment 11": [
        {
            ...
            correctAnswer: "it is causing excessive economic damage"
        },
        {
        ...
        },
        {
            ...
            correctAnswer: "increasing harvesting rate"
        },
        {
        ...
        },
        {
            ...
            correctAnswer: "The maximum sustainable yield is near the mid-point of the sigmoidal curve."
        }
    ]
};